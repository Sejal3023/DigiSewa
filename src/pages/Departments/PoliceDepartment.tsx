...
export default function PoliceDepartment() { // ⚠️ CHANGE FUNCTION NAME
  // ========================================
  // ⚠️ CHANGE THESE 2 LINES FOR EACH DEPARTMENT
  // ========================================
  const DEPARTMENT_NAME = 'Police Department';
  const LICENSE_TYPE = 'Police Verification Certificate';
  // ========================================
