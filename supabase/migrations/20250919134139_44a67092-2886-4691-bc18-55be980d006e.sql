-- Insert sample users for testing (using valid roles from constraints)
INSERT INTO public.users (id, email, name, role, password_hash) VALUES
  ('11111111-1111-1111-1111-111111111111', 'applicant@test.com', 'John Applicant', 'applicant', '$2b$10$example_hash_applicant'),
  ('22222222-2222-2222-2222-222222222222', 'admin@test.com', 'Admin User', 'admin', '$2b$10$example_hash_admin'),  
  ('33333333-3333-3333-3333-333333333333', 'dept@test.com', 'Department User', 'department', '$2b$10$example_hash_dept');
...
INSERT INTO public.role_assignments (user_id, role, department, assigned_by, is_active) VALUES
  ('22222222-2222-2222-2222-222222222222', 'admin', 'Municipal Corporation', '22222222-2222-2222-2222-222222222222', true),
  ('33333333-3333-3333-3333-333333333333', 'department_head', 'Municipal Corporation', '22222222-2222-2222-2222-222222222222', true);
