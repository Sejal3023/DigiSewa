-- Insert sample users for testing with valid roles from users_role_check constraint
INSERT INTO public.users (id, email, name, role, password_hash) VALUES
  ...
  ('33333333-3333-3333-3333-333333333333', 'department@test.com', 'Department User', 'department', '$2b$10$example_hash_department');

-- Insert role assignments for the test users (treating department as super admin equivalent)
